 ...
 * @package bitgfzc
 */
namespace BitCode\BITGFZC\Integration;
...
use FilesystemIterator;use WP_Error;
use WP_REST_Request;
use WP_REST_Server;
...
final class Integrations
{
    ...
    public function save($data)
    {
        ...
        if (!is_null($missing_field)) {
            wp_send_json_error(sprintf(__('%s cann\'t be empty', 'bitgfzc'), $missing_field));
        }
        ...
        wp_send_json_success(['id' => $saveStatus, 'msg' => __('Integration saved successfully', 'bitgfzc')]);
    }
    ...
    public function update($data)
    {
        ...
        wp_send_json_success(__('Integration updated successfully', 'bitgfzc'));
    }
    ...
    public function delete($data)
    {
        ...
        wp_send_json_success(__('Integration deleted successfully', 'bitgfzc'));
    }
    ...
    public function toggle_status($data)
    {
        ...
        wp_send_json_success(__('Integration status changed successfully', 'bitgfzc'));
    }
